    ...
    <div class="account-details-box"> 
      ...
      <form class="account-details-form">
        <div class="edit-account-brief">
          ...
          <textarea class="account-brief-text" id="brief" placeholder="نبذة قصيرة عنك"></textarea>
        </div>
        <div class="interests edit-account-brief">
          <label for="#interests">الاهتمامات</label>
          <textarea class="account-interests-text account-brief-text" id="interests" placeholder="الاهتمامات"></textarea>
        </div>
