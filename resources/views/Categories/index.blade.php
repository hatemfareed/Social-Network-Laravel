          ...
          <div class="container">
            <div class="global-section-layout">
              <div class="categories-container d-grid">
                <div class="col"><a class="card customized-card category-card" href="{{route('all-books')}}">
                    <div class="card-img-box"><img class="card-img-top" src="/assets/images/technology.webp" alt="technology"></div>
                    <div class="card-body">
                      <h5 class="card-title">التكنولوجيا</h5>
                    </div></a></div>
                <div class="col"><a class="card customized-card category-card" href="../category-page.html">
                    <div class="card-img-box"><img class="card-img-top" src="/assets/images/political-science.jpg" alt="political science"></div>
                    <div class="card-body">
                      <h5 class="card-title">العلوم السياسية</h5>
                    </div></a></div>
                <div class="col"><a class="card customized-card category-card" href="../category-page.html">
                    <div class="card-img-box"><img class="card-img-top" src="/assets/images/food.jpg" alt="food"></div>
                    <div class="card-body">
                      <h5 class="card-title">الطعام</h5>
                    </div></a></div>
                <div class="col"><a class="card customized-card category-card" href="../category-page.html">
                    <div class="card-img-box"><img class="card-img-top" src="/assets/images/space-science.png" alt="space science"></div>
                    <div class="card-body">
                      <h5 class="card-title">علوم الفضاء</h5>
                    </div></a></div>
                <div class="col"><a class="card customized-card category-card" href="../category-page.html">
                    <div class="card-img-box"><img class="card-img-top" src="/assets/images/physics.jpg" alt="physics"></div>
                    <div class="card-body">
                      <h5 class="card-title">الفيزياء</h5>
                    </div></a></div>
                <div class="col"><a class="card customized-card category-card" href="../category-page.html">
                    <div class="card-img-box"><img class="card-img-top" src="/assets/images/sport.jpg" alt="sport"></div>
                    <div class="card-body">
                      <h5 class="card-title">الرياضة</h5>
                    </div></a></div>
                <div class="col"><a class="card customized-card category-card" href="../category-page.html">
                    <div class="card-img-box"><img class="card-img-top" src="/assets/images/art.webp" alt="art"></div>
                    <div class="card-body">
                      <h5 class="card-title">الفنون</h5>
                    </div></a></div>
                <div class="col"><a class="card customized-card category-card" href="../category-page.html">
                    <div class="card-img-box"><img class="card-img-top" src="/assets/images/adab.jpg" alt="adab"></div>
                    <div class="card-body">
